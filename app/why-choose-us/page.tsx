...
const content = [
  ...
  {
    title: "Assessment",
    description: "Based on the student profile, assessments are done to measure progress and understanding",
    content: "📊"
  },
  {
    title: "Quiz",
    ...
    <div className={cn("min-h-screen bg-white", manrope.className)}>
      ...
      <div className="min-h-[calc(100vh-4rem)] bg-white">
        ...
        >
          ...
          <div
            className="hidden lg:block h-60 w-80 rounded-md bg-white sticky top-10 overflow-hidden border border-gray-200"
          >
